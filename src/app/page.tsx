          ...
          <div>
            ...
            <div className="flex gap-4 mt-6">
              ...
              <a
                ...
                className="px-6 py-2 bg-gray-200 dark:bg-slate-700 text-gray-900 dark:text-white font-semibold rounded-lg hover:bg-gray-300 dark:hover:bg-slate-600 transition-all"
              >
                Experience
              </a>
            </div>
